...
func TestCostSummaryHandlerAggregatesProviderDisplayCosts(t *testing.T) {
	...
	h := &CostHandlers{
		store: &stubCostAPIStore{
			...
			pricingGroups: []store.CostPricingGroup{
				{ProviderName: "claude-max", ModelUpstream: "claude-sonnet-4-20250514", InputTokens: 100, OutputTokens: 50, Requests: 1},
				{ProviderName: "claude-max", ModelUpstream: "claude-opus-4-20250514", InputTokens: 20, OutputTokens: 10, Requests: 1},
			},
		},
		tz:   time.UTC,
		calc: calc,
...
func TestCostSummaryHandlerAggregatesLegacyProviderDisplayCosts(t *testing.T) {
	...
	h := &CostHandlers{
		store: &stubCostAPIStore{
			...
			pricingGroups: []store.CostPricingGroup{
				{ProviderName: "chatgpt-pro", ModelUpstream: "gpt-5.4", InputTokens: 100, OutputTokens: 20, Requests: 1},
				{ProviderName: "openai_responses:chatgpt.com", ModelUpstream: "gpt-5.4", InputTokens: 200, OutputTokens: 40, Requests: 1},
			},
		},
		tz:   time.UTC,
		calc: calc,
